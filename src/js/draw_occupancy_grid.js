export function draw_occupancy_grid(canvas, map_data, robotPosition) {
    ...
    if (robotPosition) {
        let robotSize = { width: 4, height: 4 };
...
function evaluarGradiente(valor) {
    ...
    var colores = [
        [0, 0, 0], [0, 0, 0], [255, 0, 255], [250, 0, 0], [0, 255, 255]
    ];
    ...
    if (typeof color1 !== 'undefined' && typeof color2 !== 'undefined'
        && color1.length > 0 && color2.length > 0) {
