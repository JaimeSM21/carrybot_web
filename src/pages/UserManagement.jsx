...
.cb-footer-logo-img {
  height: 30px; /* Un poco más pequeño que en el Navbar para que sea sutil */
  width: auto;
  object-fit: contain;
  display: block;
}
...
.cb-footer-logo-text span {
  color: #f5c518; /* El color amarillo para "bot" */
}

.cb-footer-copy {
  font-size: 13px;
  color: rgba(255, 255, 255, 0.8); /* Un blanco ligeramente transparente para que no resalte tanto */
}
`
